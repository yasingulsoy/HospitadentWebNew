...
const HastaYorumlari = () => {
  ...
  return (
    <>
      <SEOHead 
        title="Patient Reviews - Hospitadent"
        description="Hospitadent patient reviews and ratings. Real patient experiences, Google and Trustpilot reviews. 4.8/5 average rating for patient satisfaction."
        keywords="hospitadent reviews, patient ratings, google reviews, trustpilot, patient satisfaction, dentist reviews"
        url="https://hospitadent.com/en/patient-reviews"
        structuredData={{
