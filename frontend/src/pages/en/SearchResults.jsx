    ...
    const mockResults = [
      {
        ...
        excerpt: 'Professional dental implant treatment with modern technology...',
        url: '/en/services',
        category: 'Services'
      },
      {
        id: 2,
        title: 'About Hospitadent',
        excerpt: 'Learn about our history, mission and values...',
        url: '/en/about',
        category: 'About'
      },
      {
        id: 3,
        title: 'Our Branches',
        excerpt: 'Find the nearest Hospitadent branch to you...',
        url: '/en/branches',
        category: 'Branches'
      }
    ];
