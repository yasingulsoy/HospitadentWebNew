...
const HastaYorumlari = () => {
  ...
  return (
    <>
      <SEOHead 
        title="Avis Patients - Hospitadent"
        description="Avis et évaluations des patients Hospitadent. Expériences réelles de patients, avis Google et Trustpilot. Note moyenne de 4,8/5 pour la satisfaction des patients."
        keywords="avis hospitadent, évaluations patients, avis google, trustpilot, satisfaction patients, avis dentiste"
        url="https://hospitadent.com/fr/avis-patients"
        structuredData={{
