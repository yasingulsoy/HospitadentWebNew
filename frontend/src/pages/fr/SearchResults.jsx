...
const SearchResults = () => {
  ...
  useEffect(() => {
    ...
    const mockResults = [
      {
        id: 1,
        title: 'Traitement d\'implant dentaire',
        excerpt: 'Traitement d\'implant dentaire professionnel avec technologie moderne...',
        url: '/fr/services',
        category: 'Services'
      },
      {
        id: 2,
        title: 'À propos d\'Hospitadent',
        excerpt: 'Apprenez notre histoire, mission et valeurs...',
        url: '/fr/a-propos',
        category: 'À propos'
      },
      {
        ...
        excerpt: 'Trouvez la succursale Hospitadent la plus proche de vous...',
        url: '/fr/succursales',
        category: 'Succursales'
      }
    ];
